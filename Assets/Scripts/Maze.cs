...
public class Maze : MonoBehaviour
{
    ...
    public IEnumerator Generate ()
    {
        ...
        var delay = new WaitForSeconds(stepDelay);     // Suspend coroutine execution with this

        FirstGenerationStep();
        while(activeCells.Count > 0)
        {
            yield return delay;                        // Suspend coroutine execution here
            NextGenerationSteps();
        }
    }
    ...
    // Returns coordinates of a random cell in the maze
